...
const StatisticsBlock: React.FC<ChartsBlockProps> = memo(
  function StatisticsBlock({ statsList, team, teamStatlist }) {
    ...
    return (
      <div className="relative w-full flex-col justify-center gap-8 space-y-4 overflow-hidden rounded-2xl border border-orange-500/10 bg-gradient-to-b from-orange-950/15 via-gray-950 to-gray-950 px-3 py-4 md:flex md:space-y-0 md:space-x-4 lg:px-8">
        <div className="relative space-y-4 text-center">
          <h1 className="font-righteous bg-linear-to-r from-orange-400 via-orange-300 to-orange-200 bg-clip-text text-6xl leading-tight font-bold text-transparent md:pt-8">
            {team.name}
          </h1>
          <p className="pt-2 text-xl font-light tracking-wide text-gray-300">
