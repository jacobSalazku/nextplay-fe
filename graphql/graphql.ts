...
export type AcceptTeamInviteResponse = {
  __typename?: 'AcceptTeamInviteResponse';
...
export type CreatePlayInput = {
  ...
  diagram?: InputMaybe<Scalars['JSON']['input']>;
  name: Scalars['String']['input'];
  routeKey: Scalars['String']['input'];
};
...
export type Mutation = {
  ...
  createTeam: Team;
  createTeamInvite: TeamInviteResponse;
...
export type MutationCreateTeamInviteArgs = {
...
export type Play = {
  ...
  diagram?: Maybe<Scalars['JSON']['output']>;
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
...
export type PlayEditorConfig = {
  __typename?: 'PlayEditorConfig';
  actionTypes: Array<PlayActionType>;
  courts: Array<CourtType>;
  formations: Array<FormationPreset>;
  objectKinds: Array<PlayObjectKind>;
};
...
export type LoginWithGoogleMutation = { __typename?: 'Mutation', loginWithGoogle: { __typename?: 'AuthPayload', accessToken: string, refreshToken: string, hasOnBoarded: boolean, userId: string } };

export type DevLoginMutationVariables = Exact<{
  email: Scalars['String']['input'];
}>;


export type DevLoginMutation = { __typename?: 'Mutation', devLogin: { __typename?: 'AuthPayload', accessToken: string, refreshToken: string, hasOnBoarded: boolean, userId: string } };
...
export type CreatePlayMutation = { __typename?: 'Mutation', createPlay: { __typename?: 'Play', id: string, routeKey: string, name: string, description: string, category: Category, canvas?: string | null, diagram?: any | null, createdAt: string, updatedAt: string } };
...
export type GetPlayQuery = { __typename?: 'Query', getPlay?: { __typename?: 'Play', id: string, routeKey: string, name: string, category: Category, description: string, canvas?: string | null, diagram?: any | null, createdAt: string, updatedAt: string } | null };
...
export type GetPlaysQuery = { __typename?: 'Query', getPlays: Array<{ __typename?: 'Play', id: string, routeKey: string, name: string, category: Category, description: string, canvas?: string | null, createdAt: string, updatedAt: string }> };

export type PlayEditorConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type PlayEditorConfigQuery = { __typename?: 'Query', playEditorConfig: { __typename?: 'PlayEditorConfig', courts: Array<CourtType>, formations: Array<{ __typename?: 'FormationPreset', id: string, name: string, court: CourtType, objects: any }> } };
...
export type UpdatePlayMutation = { __typename?: 'Mutation', updatePlay: { __typename?: 'Play', id: string, routeKey: string, name: string, category: Category, description: string, canvas?: string | null, diagram?: any | null, updatedAt: string } };
...
export type AcceptTeamInviteMutationVariables = Exact<{
  input: AcceptTeamInviteInput;
}>;


export type AcceptTeamInviteMutation = { __typename?: 'Mutation', acceptTeamInvite: { __typename?: 'AcceptTeamInviteResponse', status: AcceptTeamInviteStatus, teamId?: string | null, routeKey?: string | null, memberId?: string | null } };
...
export const DevLoginDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DevLogin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"devLogin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"email"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"refreshToken"}},{"kind":"Field","name":{"kind":"Name","value":"hasOnBoarded"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}}]}}]} as unknown as DocumentNode<DevLoginMutation, DevLoginMutationVariables>;
...
export const PlayEditorConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PlayEditorConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"playEditorConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"courts"}},{"kind":"Field","name":{"kind":"Name","value":"formations"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"court"}},{"kind":"Field","name":{"kind":"Name","value":"objects"}}]}}]}}]}}]} as unknown as DocumentNode<PlayEditorConfigQuery, PlayEditorConfigQueryVariables>;
export const UpdatePlayDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdatePlay"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdatePlayInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updatePlay"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"routeKey"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"canvas"}},{"kind":"Field","name":{"kind":"Name","value":"diagram"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<UpdatePlayMutation, UpdatePlayMutationVariables>;
...
export const AcceptTeamInviteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AcceptTeamInvite"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AcceptTeamInviteInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"acceptTeamInvite"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"teamId"}},{"kind":"Field","name":{"kind":"Name","value":"routeKey"}},{"kind":"Field","name":{"kind":"Name","value":"memberId"}}]}}]}}]} as unknown as DocumentNode<AcceptTeamInviteMutation, AcceptTeamInviteMutationVariables>;
export const CreateTeamInviteDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateTeamInvite"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateTeamInviteInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTeamInvite"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"token"}},{"kind":"Field","name":{"kind":"Name","value":"inviteLink"}},{"kind":"Field","name":{"kind":"Name","value":"teamId"}},{"kind":"Field","name":{"kind":"Name","value":"expiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"maxUses"}},{"kind":"Field","name":{"kind":"Name","value":"usedCount"}},{"kind":"Field","name":{"kind":"Name","value":"createdBy"}}]}}]}}]} as unknown as DocumentNode<CreateTeamInviteMutation, CreateTeamInviteMutationVariables>;
